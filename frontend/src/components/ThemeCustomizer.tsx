            ...
            <DropdownMenuTrigger asChild>
                ...
                >
                    <div className="relative">
                        ...
                        {/* Color theme indicator, shown only for non-default themes */}
                        {color !== "neutral" && (
                            <div
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {COLOR_THEMES.map((colorTheme) => (
                            <Button
                                ...
                                variant="ghost"
                                className="relative h-auto flex-col items-center gap-1 p-2 hover:bg-accent hover:text-accent-foreground"
