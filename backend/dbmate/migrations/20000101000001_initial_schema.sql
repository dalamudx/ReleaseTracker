...
-- migrate:down
DROP TABLE IF EXISTS executor_desired_state;
DROP TABLE IF EXISTS executor_service_bindings;
DROP TABLE IF EXISTS tracker_current_releases;
DROP TABLE IF EXISTS tracker_release_history_sources;
DROP TABLE IF EXISTS tracker_release_history;
DROP TABLE IF EXISTS source_release_run_observations;
DROP TABLE IF EXISTS source_release_history;
DROP TABLE IF EXISTS source_fetch_runs;
DROP TABLE IF EXISTS canonical_release_observations;
DROP TABLE IF EXISTS canonical_releases;
DROP TABLE IF EXISTS source_release_observations;
DROP TABLE IF EXISTS aggregate_tracker_sources;
DROP TABLE IF EXISTS aggregate_trackers;
DROP TABLE IF EXISTS executor_snapshots;
DROP TABLE IF EXISTS executor_run_history;
DROP TABLE IF EXISTS executor_status;
